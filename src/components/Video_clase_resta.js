...
import cresta from '../assets/Clases/resta.mp4';
...
export default class Video_clase_resta extends Component{
    constructor(props){
        super(props);
    }
    imgback={
        ...
        return(
            ...
            >
                <div className='container'>
                    <Card style={{border: 0}}>
                        <Card.Header style={this.estilos} className="">Resta</Card.Header>
                    ...
                    <div style={{paddingTop: '10%'}}>
                        ...
                        <Card.Body>
                                <video width="100%" height="100%" controls>
                                    <source src={cresta} type='video/mp4'></source>
                                </video>
                                <br/>

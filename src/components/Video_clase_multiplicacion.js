...
import cmulti from '../assets/Clases/Multiplicacion.mp4';
...
export default class Video_clase_multiplicacion extends Component{
    constructor(props){
        super(props);
    }
    imgback={
        ...
        return(
            ...
            >
                ...
                <div className='container'>
                    <Card style={{border: 0}}>
                        <Card.Header style={this.estilos} className="">Multiplicacion</Card.Header>
                    ...
                    <div style={{paddingTop: '10%'}}>
                        ...
                        <Card.Body>
                                <video width="100%" height="100%" controls>
                                    <source src={cmulti} type='video/mp4'></source>
                                </video>
                                <br/>
